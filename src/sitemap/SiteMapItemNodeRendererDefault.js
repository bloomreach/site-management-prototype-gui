...
import './sitemap-node-renderer-default.css';
...
class SiteMapItemNodeRendererDefault extends Component {
  render () {
    const {
    ...
    if (canDrag) {
      if (typeof node.children === 'function' && node.expanded) {
        ...
        handle = connectDragSource(<div className="rst__moveHandle" style={{padding: '10px'}}>
          <Icon className="fa fa-sitemap" style={{color: 'grey', fontSize: 18, width: '1.5em'}}/>
        </div>, {
          dropEffect: 'copy',
        });
      }
...
SiteMapItemNodeRendererDefault.defaultProps = {
  isSearchMatch: false,
  isSearchFocus: false,
  canDrag: false,
...
SiteMapItemNodeRendererDefault.propTypes = {
...
export default SiteMapItemNodeRendererDefault;